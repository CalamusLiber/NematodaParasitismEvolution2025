...
rnaseq_list=$(ls $DIR_asm/*_trinity.Trinity.fasta | sed -e "s#$DIR_asm\/##g;s#_trinity.Trinity.fasta##g")
...
do 
    ...
    qares=$($DIR_cnd/envs/rnaseqenv/bin/TrinityStats.pl $DIR_asm/${nrna}_trinity.Trinity.fasta) && 
